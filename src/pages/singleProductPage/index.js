...
import { addToWishListHandler, deleteWishListHandler, getSingleProduct, deleteCartHandler, addToCart } from "../../utils/handler";
...
export const SingleProduct = () => {
  ...
  //   const isWishlist = state.wishListData.map(
    ...
    <div className="cart-display-container flex-column flex-center md-mg">
      <div className="item-container flex">
        <div className="product-img-container">
          <img className="single-product-img" src={singleProduct.img_url} alt={singleProduct.img_name} />
        </div>
        <div className="product-content-container flex-column">
          <div className="single-product-cart-title black-color">{singleProduct.product_name}</div>
          ...
          <div className="price-tag flex price-section">
            ...
            <div className="price-offer-cart primary-color">{singleProduct.product_offer}% off</div>
          </div>
...
{/* } */}
          ...
          {/* {!inWishlist ? ( */}
            ...
            onClick={() => addToWishListHandler(singleProduct, dispatch, navigate)}
          >
            Add to Wishlist
          </button>
           {/* ) : (
